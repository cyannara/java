...
public class FriendData {
	...
	private void dataInit() {
		...
		friends[2] = new SchoolFriend("한국대학교", "홍길순", "010-1111-1113");
		friends[3] = new CompanyFriend("한국주식회사", "김치국", "010-1111-1114");
		friends[4] = new SchoolFriend("한국대학교", "박오름", "010-1112-1111");
		friends[5] = new CompanyFriend("한국주식회사", "김기자", "010-1113-1111");
		friends[6] = new SchoolFriend("미국대학교", "박공부", "010-1114-1111");
		...
		friends[12] = new SchoolFriend("미국대학교", "홍공부", "010-1311-1111");
		friends[13] = new SchoolFriend("미국대학교", "최상위", "010-1411-1111");
		friends[14] = new SchoolFriend("한국대학교", "최하위", "010-1151-1111");
		...
		friends[18] = new SchoolFriend("미국대학교", "서공부", "010-1271-1111");
